    ...
    <div className="container mx-auto px-6 md:px-12 py-12 max-w-7xl">
      ...
      <div className="flex overflow-x-auto gap-3 pb-4 mb-8 hide-scrollbar">
        {categories.map((cat) => (
          <button
            key={cat}
            onClick={() => handleCategoryClick(cat)} // Uses our new handle function
...
//               <ProductGrid products={processedProducts} />
//             ) : (
//               <div className="text-center py-20 text-gray-500 text-lg font-medium">No products match your filters. Try adjusting them!</div>
//             )}
//           </motion.div>
//         </AnimatePresence>
//       </motion.div>
